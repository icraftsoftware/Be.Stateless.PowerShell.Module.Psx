   ...
   InModuleScope Psx {
      ...
      Context 'When neither key nor entry exist.' {
         It 'Returns false.' {
            ...
            Test-RegistryEntry -Key 'TestRegistry:\Key1' -Entry entry | Should -BeFalse
         }
      }
      ...
      Context 'When key exists but entry does not.' {
         ...
         It 'Returns false.' {
            Test-Path -Path 'TestRegistry:\Key2' | Should -BeTrue
            Test-RegistryEntry -Key 'TestRegistry:\Key2' -Entry entry | Should -BeFalse
         }
      }
